 ...
 *
 * Class OM4\Zapier\SendQueue
 */
class SendQueue {

	/** @var OM4\Zapier\SendQueue The single instance of the class */
	...
	/**
	 * Main OM4\Zapier\SendQueue Instance.
	 *
	 * Ensures only one instance of OM4\Zapier\SendQueue is loaded or can be loaded.
	 *
	 * @since 1.7.0
	 * @static
	 * @return OM4\Zapier\SendQueue Main instance
	 */
	 ...
	 *
	 * @param OM4\Zapier\Trigger\Base $trigger The Trigger
