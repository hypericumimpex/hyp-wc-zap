...
class FeedFactory {
	 ...
	 *
	 * @param OM4\Zapier\Trigger\base $trigger
	 * @return OM4\Zapier\Feed\Feed[] Array of OM4\Zapier\Feed\Feed objects
	 */
	 ...
	 * @param OM4\Zapier\Trigger\Base       $trigger Trigger    Search for this Trigger.
	 * @param null|int|OM4\Zapier\Feed\Feed $feed_to_exclude    Feed not to include in the search.
	 *
	 * @return int
	 */
	 ...
	 * @param int|OM4\Zapier\Feed\Feed $feed_to_exclude Optional feed not to include in the search
	 *
	 * @return int
	 */
